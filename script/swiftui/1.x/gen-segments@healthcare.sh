...
export PROJECT_NAME="$SPEC"@swiftui"#"healthcare-1.x
...
##                                                                            ##
################################################################################
REPOS=("swift-mobile@swiftui-1.x" "swift-mobile@swiftui#healthcare-1.x" \
       "swift-sdk@universal-1.x")

for repo in "${REPOS[@]}"
do
export TEMPLATE_ROOT=$GUIDBASE_DATA_ROOT/swift/$repo
...
\"version\":\"1.0.0\",\
\"description\":\"\",\
\"naming\":\"com.doublegsoft.jcommons.programming.swift.SwiftConventions\",\
\"globalNamingConvention\":\"com.doublegsoft.jcommons.programming.swift.SwiftNamingConvention\",\
\"language\":\"swift\",\
\"imports\":\
\[\],\
\"dependencies\":\
